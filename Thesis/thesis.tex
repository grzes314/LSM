...
\begin{figure}[!ht]
\centering
 \includegraphics[scale=0.66]{images/Architecture/readingModel.png}
...
\begin{figure}[!hb]
\centering
 \includegraphics[scale=1]{images/Architecture/newinstr.png}
...
\begin{figure}[!hb]
\centering
 \includegraphics[scale=1]{images/Architecture/newtask.png}
...
\begin{figure}[!ht]
\centering
 \includegraphics[scale=1]{images/Architecture/results.png}
 \includegraphics[scale=0.5]{images/Architecture/plot.png}
