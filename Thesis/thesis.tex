...
\centering
 \includegraphics*[scale=0.75, viewport = 30 165 800 580]{images/Architecture/trajectories.pdf}
...
\begin{sidewaysfigure}
\centering
 \includegraphics*[scale=0.75, viewport = 30 120 785 590]{images/Architecture/instr.pdf}
...
In the thesis several versions of the Monte Carlo method were presented. Each of them has its own representation in the methods' class hierarchy presented in Figure \ref{fig:arch:MonteCarlo}.
\begin{figure}
\centering
